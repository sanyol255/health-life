<x-main-layout :title="' - Workout Exercises'">
    ...
    <header>
        ...
        <section class="flex flex-row justify-center mt-6 space-x-32">
            ...
            <span class="bg-[#5cb85c] text-white p-3 rounded-md hover:bg-[#0c570c] hover:text-orange-300"><a href="{{ route('pullups.index') }}">Pullups</a></span>
            <span class="bg-[#467fd0] text-white p-3 rounded-md hover:bg-[#034680] hover:text-orange-300"><a href="{{ route('squats.index') }}">Squats</a></span>
